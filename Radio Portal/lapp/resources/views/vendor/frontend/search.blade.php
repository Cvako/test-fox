...
<div class="container mt-3">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="col-12">
                <h6 class="alert alert-no-record">@lang('general.search_box_warning')</h6>
            </div>
            @else

            @if(!$errors->any())
            <span class="section-title mb-3">@lang('general.search_results_for') "{{$search_query}}"</span>
            @endif

            @if($errors->any())
            <div class="col-12">
                <h6 class="alert alert-no-record">@lang('general.min_3_letters')</h6>
            </div>
            @else

            @if($stations->isEmpty())
            <div class="col-12">
                <h6 class="alert alert-no-record">@lang('general.no_search_results')</h6>
            </div>
            @endif
