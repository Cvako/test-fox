    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="row radio-channels"></div>
			  ...
			  <script>
                var ked = Cookies.get('{{ $settings['cookie_prefix'].'_history' }}');
                ...
                if (ked != undefined && ked != '') {
                    ...
                    $(".radio-channels").prepend('<div class="col-md-12 col-12 text-white mb-3">@lang('general.no_listen_history')</div>');
                }
            </script>
